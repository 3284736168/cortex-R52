# Copyright (c) 2007-2023 Arm Limited (or its affiliates). All rights reserved.
# Use, modification and redistribution of this file is subject to your possession of a
# valid End User License Agreement for the Arm Product of which these examples are part of 
# and your compliance with all applicable terms and conditions of such license agreement.
#
# This example is intended to be built with GCC 13.2.1 for bare-metal targets
#
...
APP ?= startup_Cortex-R52_GIC_GCC.axf
OPT_LEVEL ?= 1
CODE_TYPE ?= thumb
...
ASFLAGS = $(DEBUG_FLAGS)
LDFLAGS = -T gcc.ld --specs=rdimon-v2m.specs -Wl,--build-id=none,-Map=linkmap.txt,--gc-sections
TARGET_ARCH = -mcpu=$(CPU) -mfpu=neon-fp-armv8 -mfloat-abi=hard -m$(CODE_TYPE) # Used for .c
